            ...
            mDatabaseRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Iterable<DataSnapshot> requestList = dataSnapshot.child(key).child("Requests").getChildren();
                            ...
                            final int originalmonth = calendar.get(Calendar.MONTH) + 1;
                            final int originalday = calendar.get(Calendar.DAY_OF_MONTH);
                        String current_Month=String.valueOf(originalmonth);
                        String currentDay_of_month = String.valueOf(originalday);
                        String current_hourOfDay = String.valueOf(hour);
                    ...
                    for(DataSnapshot data : requestList) {
                        ...
                        String dataBaseTime = upload.time;
                        String CustomerName = upload.customerName;
                        ...
                        String hour1 = String.valueOf(dataBaseTime.charAt(0) + dataBaseTime.charAt(1));
                        int hour2 = Integer.valueOf(hour1) ;
                        int date = Integer.valueOf(date6);
                        ...
                        if(month.equals(current_Month))
                        {
                          ...
                          else if(date<originalday)
                            {
                                //Toast.makeText(Main3Activity.this,CustomerName,Toast.LENGTH_SHORT).show();
                                mDatabaseRef.child("key").child("Requests").child(CustomerName).removeValue();
                            }
                        }
                        if(month1<originalmonth)
                        {
                            mDatabaseRef.child("key").child("Requests").child(CustomerName).removeValue();
                        }
                    }
